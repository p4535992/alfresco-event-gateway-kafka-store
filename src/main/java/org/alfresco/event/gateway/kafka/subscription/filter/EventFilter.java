...
/**
 * Predicate definition for the class {@link RepoEvent} to be able to define event filters that check different
 * conditions in the corresponding events (i.e. the node type has changed, a property has a specific value, etc.).
 */
@FunctionalInterface
